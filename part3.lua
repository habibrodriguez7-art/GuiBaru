...
task.spawn(function()
    local success, result = pcall(function()
        local response = game:HttpGet("https://raw.githubusercontent.com/habibrodriguez7-art/GuiBaru/refs/heads/main/version.txt")
        if response then
            ...
            if latestVersion and latestVersion ~= currentVersion then
                if Notify then
                    Notify.Send("Update Available", "New version " .. latestVersion .. " is available!", 5)
                end
            end
        end
    end)
