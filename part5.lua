...
-- ============================================
-- LOAD COMBINED MODULES DIRECTLY
-- ============================================
local CombinedModules = loadstring(game:HttpGet("https://raw.githubusercontent.com/habibrodriguez7-art/GuiBaru/refs/heads/main/CombinedModule.lua"))()

if not CombinedModules then
    warn("❌ Failed to load CombinedModules. Please check the URL in the script.")
    return
end
