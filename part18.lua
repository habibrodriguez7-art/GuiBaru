...
-- ============================================
-- SECURITY LOADER - WITH ERROR HANDLING
-- ============================================
local SecurityLoader = nil
local success, err = pcall(function()
    SecurityLoader = loadstring(game:HttpGet("https://raw.githubusercontent.com/habibrodriguez7-art/GuiBaru/refs/heads/main/SecurityLoader.lua"))()
end)

if not success or not SecurityLoader then
    warn("Failed to load SecurityLoader:", err)
    error("SecurityLoader is required to run this script. Please check your internet connection.")
    return
end
...
-- Only round top corners for seamless connection with body
...
local titleIcon = new("ImageLabel",{
    Parent=scriptHeader,
    Image="rbxassetid://102019211120883",
