...
local function updatePlayerList()
    ...
    playerDropdown = makeDropdown(teleportPage, "Teleport to Player", "rbxassetid://86355568065894", playerItems, nil, function(selectedPlayer)
...
local lastUpdate = 0
ConnectionManager:Add("playerAdded", Players.PlayerAdded:Connect(function()
    local now = tick()
...
ConnectionManager:Add("playerRemoving", Players.PlayerRemoving:Connect(function()
    local now = tick()
    if now - lastUpdate < 0.5 then return end
    lastUpdate = now
    task.wait(0.1)
