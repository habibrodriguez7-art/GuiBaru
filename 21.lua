...
-- Vertical separator line on the right side of sidebar (matching header separator style)
local sidebarSeparator = new("Frame",{
    Parent=win,
    Size=UDim2.new(0, 2, 1, -50),
...
new("UICorner",{Parent=sidebarSeparator, CornerRadius=UDim.new(1, 0)})
