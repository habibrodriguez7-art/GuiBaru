...
local separator = new("Frame",{
    ...
    Position=UDim2.new(0, 145, 0.5, -12),
    BackgroundColor3=colors.primary,
...
local btnMain = createNavButton("Dashboard", "rbxassetid://123456789", "Main", 1) -- Replace with your PNG image ID
local btnTeleport = createNavButton("Teleport", "rbxassetid://123456789", "Teleport", 2) -- Replace with your PNG image ID
local btnShop = createNavButton("Shop", "rbxassetid://123456789", "Shop", 3) -- Replace with your PNG image ID
local btnWebhook = createNavButton("Webhook", "rbxassetid://123456789", "Webhook", 4) -- Replace with your PNG image ID
local btnCameraView = createNavButton("Camera View", "rbxassetid://123456789", "CameraView", 5) -- Replace with your PNG image ID
local btnSettings = createNavButton("Settings", "rbxassetid://123456789", "Settings", 6) -- Replace with your PNG image ID
local btnInfo = createNavButton("About", "rbxassetid://123456789", "Info", 7) -- Replace with your PNG image ID
