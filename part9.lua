...
local contentBg = new("Frame",{
    Parent=win,
    Size=UDim2.new(1, -(sidebarWidth + 12), 1, -58),
    Position=UDim2.new(0, sidebarWidth + 6, 0, 52),
    BackgroundColor3=colors.bg2,
...
-- Add subtle border to content area
...
local function createNavButton(text, imageId, page, order)
    ...
    -- Add subtle stroke to active button
    ...
    local textLabel = new("TextLabel",{
        ...
        TextTransparency=page == currentPage and 0.05 or 0.4,
        TextXAlignment=Enum.TextXAlignment.Left,
        ZIndex=7
    })
...
local function makeCategory(parent, title, icon)
    ...
    new("UIListLayout",{Parent=contentContainer, Padding=UDim.new(0, 7)})
    ...
    header.MouseButton1Click:Connect(function()
        ...
        if USE_TWEEN then
            ...
            categoryFrame.BackgroundTransparency = isOpen and 0.45 or 0.6
        end
    end)
